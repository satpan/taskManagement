...
public class TaskManagementApp {
    ...
    private static final Logger log = LoggerFactory.getLogger(TaskManagementApp.class);

    private final Environment env;

    public TaskManagementApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes taskManagement.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(TaskManagementApp.class);
