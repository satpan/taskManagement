...
import { TaskManagementSharedModule, UserRouteAccessService } from './shared';
import { TaskManagementAppRoutingModule} from './app-routing.module';
import { TaskManagementHomeModule } from './home/home.module';
import { TaskManagementAdminModule } from './admin/admin.module';
import { TaskManagementAccountModule } from './account/account.module';
...
@NgModule({
    imports: [
        ...
        TaskManagementAdminModule,
        TaskManagementAccountModule,
